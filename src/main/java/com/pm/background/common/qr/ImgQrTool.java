    ...
    public static void main(String[] args) throws IOException {
        for (int i = 1; i <= 1; i++) {
            QrImage para = new QrImage.Builder()
                    .setFileOutputPath("H:\\二维码\\delay\\" + i + ".jpg")
                    .setQrContent("http://www.baidu.com?a=" + "123")
                    .setQrHeight(300)
                    .setQrWidth(300)
                    .setQrIconFilePath("H:\\二维码\\中间图标\\1.png")
                    .setTopWrodHeight(100)
                    .setWordContent("阿里巴巴" + 1)
                    .setWordSize(18).build();
            ImgQrTool.createQrWithFontsAbove(para);
        }
//       String html = "<html>" +
//               "<head></head>" +
//               "<body><h1>我们是共产主义接班人</h1></body>"+
//               "</html>";
//
//        createSimpleQr(html,200,200,"H:\\二维码\\delay\\1.jpg");
    }
}
